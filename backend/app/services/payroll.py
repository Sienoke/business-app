...
def calculate_employee_cost(employee: Employee, company: Company, avg_salary: float = None) -> dict:
    ...
    # Debug output
    print(f"DEBUG: Rates for {employee.full_name}: income_tax_rate={income_tax_rate}, fszn_employee_rate={fszn_employee_rate}, fszn_employer_rate={fszn_employer_rate}, belgosstrakh_rate={belgosstrakh_rate}")
    print(f"DEBUG: gross={gross}")
